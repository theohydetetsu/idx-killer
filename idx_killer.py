...
# ==========================================
CACHE_FILE = "jihan_ghina_saham_cache_v19_2.json"
...
# ==========================================
# 1. LUXURY UI & COMFORT EYE-CARE CSS (V19.2)
# ==========================================
st.set_page_config(page_title="JIHAN-GHINA Ultimate V19.2", page_icon="✨", layout="wide")
...
with st.sidebar:
    ...
    st.markdown("<p style='color:#71717A; font-size:9px; letter-spacing:1px; margin-bottom:20px;'>EDITION V19.2</p>", unsafe_allow_html=True)
...
if not st.session_state.raw_stocks:
    ...
    with tab_export:
        ...
        if not df_all.empty:
            ...
            st.download_button(label="📥 DOWNLOAD CSV (EXCEL)", data=csv_data, file_name=f"JG_Ultimate_V19_2_Watchlist.csv", mime="text/csv", use_container_width=True)
