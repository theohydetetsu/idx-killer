            ...
            with col1:
                ...
                <div class="pro-card" style="height:100%;">
                    ...
                    <div style="display:flex; justify-content:space-between; border-bottom: 1px solid #27272A; padding-bottom: 8px;">
                        ...
                        <div style="text-align:right;"><span class="data-label">MARKET MAKER FLOW</span><span class="data-value" style="font-size:15px; color: {'#10B981' if 'AKUMULASI' in status_bandar else '#C6A87C' if 'NETRAL' in status_bandar else '#EF4444'};">{status_bandar}</span></div>
                    </div>
