...
# Bungkus seluruh kode HTML di dalam triple quotes (""" ... """)
html_code = """
<!DOCTYPE html>
<html lang="id">
<head>
...
<div class="app-container">
    ...
    <div class="card">
        ...
        <div class="ai-conclusion-box">
            ...
            <div id="aiText">
                <b>Sinyal Beli Kuat!</b> Terdeteksi Akumulasi masif dari Whale tepat di area krusial Support Golden Pocket 61.8%. Momentum saat ini Bullish (Harga di atas VWAP) dan didukung Kinerja fundamental stabil. <br><br><i>Insight: Eksekusi di 379 memberikan potensi pantulan (Jackpot) dengan risiko Cut Loss sangat rendah.</i>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="fibo-row"><span>100% (High)</span> <span>466</span></div>
        <div class="fibo-row highlight"><span>61.8% (Golden Pocket)</span> <span>374</span></div>
        <div class="fibo-row"><span>50.0% (Equilibrium)</span> <span>392</span></div>
        <div class="fibo-row"><span>38.2%</span> <span>409</span></div>
        <div class="fibo-row"><span>0% (Low)</span> <span>317</span></div>
    </div>
    ...
    <div class="card" style="text-align: center;">
        ...
        <div><span class="btn-bullish">BULLISH (P > VWAP)</span></div>
    </div>
</div>
